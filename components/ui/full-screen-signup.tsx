        ...
        <div className="p-8 md:p-12 md:w-1/2 flex flex-col bg-white/90 dark:bg-gray-800/90 backdrop-blur-md text-gray-900 dark:text-white relative">
          <div className="flex flex-col items-left mb-8">
            ...
            <p className="text-left opacity-80 dark:text-gray-300">
              Welcome to Job Assist - Let&apos;s get started
            </p>
          </div>
          ...
          >
            ...
            <div>
              <label htmlFor="password" className="block text-sm mb-2 font-medium dark:text-gray-300">
                Create new password
              </label>
              <input
                type="password"
            ...
            <div className="text-center text-gray-600 dark:text-gray-300 text-sm mt-2">
              ...
              <a href="/login" className="text-gray-900 dark:text-blue-400 hover:text-gray-700 dark:hover:text-blue-300 font-medium transition-colors">
                Login
              </a>
            </div>
          </form>
